...
#define PMIP_VERSION_MINOR    (00)

/** MLCD Driver flags */
#define MLCD_FLAG_OPENED      (1)
...
typedef enum
{
    ...
    PMIP_ERROR_VCOM_MASK_CFG         = 12,              /*!< MLCD fmask/bmask config failed  */
    PMIP_ERROR_TIMEOUT               = 13               /*!< MLCD timeout failed             */
} e_pmip_err_t;
