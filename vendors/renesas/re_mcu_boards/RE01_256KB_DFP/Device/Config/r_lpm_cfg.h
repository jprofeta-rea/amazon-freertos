...
#define LPM_CFG_SECTION_R_LPM_FASTMODULESTOP                    (SYSTEM_SECTION_CODE)   /*!<  R_LPM_FastModuleStop() section */
#define LPM_CFG_SECTION_R_LPM_POWERSUPPLYMODEALLPWONSET         (SYSTEM_SECTION_CODE)   /*!<  R_LPM_PowerSupplyModeAllpwonSet() section */
...
#define LPM_CFG_SECTION_R_LPM_SLEEPMODEENTRY                    (SYSTEM_SECTION_CODE)   /*!<  R_LPM_SleepModeEntry() section */
#define LPM_CFG_SECTION_R_LPM_SSTBYMODEENTRY                    (SYSTEM_SECTION_CODE)   /*!<  R_LPM_SSTBYModeEntry() section */
