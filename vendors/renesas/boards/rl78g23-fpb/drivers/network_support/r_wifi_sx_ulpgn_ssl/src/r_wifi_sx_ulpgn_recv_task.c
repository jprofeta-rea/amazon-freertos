...
static void wifi_analyze_get_aplist_string(uint8_t * pstring)
{
    ...
    {
        pstr1 = (char SCI_FAR*)(pstring + 7);       /* AP list length */
            ...
            *pstr2 = '\0';
            if (strlen(pstr2) <= 32)
            {
                ...
                if (g_wifi_aplist_stored_num < g_wifi_aplistmax)
                {
                    ...
                    /* ssid_length */
                    gp_wifi_ap_results->ssid_length = sizeof(gp_wifi_ap_results->ssid);
#endif
                }
...
static void wifi_analyze_get_current_ssid_string(uint8_t * pstring)
{
    ...
    {
        /* ssid */
        ptr1 = (char SCI_FAR*)pstring + strlen(tag);
        ptr2 = strchr(ptr1, '\r');
        if (NULL == ptr2)
        {
            ptr2 = '\0';
