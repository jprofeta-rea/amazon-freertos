...
#define RIIC_CFG_SECTION_IIC_TXI_INTERRUPT       (SYSTEM_SECTION_CODE)    ///< iic_txi_interrupt() section
#define RIIC_CFG_SECTION_IIC_TEI_INTERRUPT       (SYSTEM_SECTION_CODE)    ///< iic_tei_interrupt() section
#define RIIC_CFG_SECTION_IIC_RXI_INTERRUPT       (SYSTEM_SECTION_CODE)    ///< iic_rxi_interrupt() section
#define RIIC_CFG_SECTION_IIC_EEI_INTERRUPT       (SYSTEM_SECTION_CODE)    ///< iic_eei_interrupt() section
/* @} */
