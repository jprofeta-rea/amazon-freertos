...
*/
#define S14AD_CFG_ADC_S14ADI0_ISR       (SYSTEM_SECTION_CODE) ///<adc_s14adi0_isr() section
#define S14AD_CFG_ADC_GBADI_ISR         (SYSTEM_SECTION_CODE) ///<adc_gbadi_isr() section
#define S14AD_CFG_ADC_GCADI_ISR         (SYSTEM_SECTION_CODE) ///<adc_gcadi_isr() section
#define S14AD_CFG_ADC_CMPAI_ISR         (SYSTEM_SECTION_CODE) ///<adc_cmpai_isr() section
#define S14AD_CFG_ADC_CMPBI_ISR         (SYSTEM_SECTION_CODE) ///<adc_cmpbi_isr() section
#define S14AD_CFG_ADC_WCMPM_ISR         (SYSTEM_SECTION_CODE) ///<adc_wcmpm_isr() section
#define S14AD_CFG_ADC_WCMPUM_ISR        (SYSTEM_SECTION_CODE) ///<adc_wcmpum_isr() section
