...
#define SYSTEM_CFG_EVENT_NUMBER_SCI0_RXI            (SYSTEM_IRQ_EVENT_NUMBER8)  /*!< Numbers 0/4/8/12/16/20/24/28 only */
// changed 2020/10 end
...
#define SYSTEM_CFG_EVENT_NUMBER_SCI9_RXI            (SYSTEM_IRQ_EVENT_NUMBER4)  /*!< Numbers 4/12/20/28 only */
// changed 2020/10 end
...
#define SYSTEM_CFG_EVENT_NUMBER_SCI0_TXI            (SYSTEM_IRQ_EVENT_NUMBER9)  /*!< Numbers 1/5/9/13/17/21/25/29 only */
// changed 2020/10 end
...
#define SYSTEM_CFG_EVENT_NUMBER_SCI9_TXI            (SYSTEM_IRQ_EVENT_NUMBER5)  /*!< Numbers 5/13/21/29 only */
// changed 2020/10 end
...
#define SYSTEM_CFG_EVENT_NUMBER_SCI0_ERI            (SYSTEM_IRQ_EVENT_NUMBER11)  /*!< Numbers 3/7/11/15/19/23/27/31 only */
// changed 2020/10 end
...
#define SYSTEM_CFG_EVENT_NUMBER_SCI9_ERI            (SYSTEM_IRQ_EVENT_NUMBER7)  /*!< Numbers 7/15/23/31 only */
// changed 2020/10 end
...
#define SYSTEM_CFG_SECTION_R_SYS_SPEEDMODEGET               (SYSTEM_SECTION_CODE)   /*!< R_SYS_SpeedModeGet() section */
#define SYSTEM_CFG_SECTION_R_SYS_SYSTEMCLOCKHOCOSET         (SYSTEM_SECTION_CODE)   /*!< R_SYS_SystemClockHOCOSet() section */
#define SYSTEM_CFG_SECTION_R_SYS_SYSTEMCLOCKMOCOSET         (SYSTEM_SECTION_CODE)   /*!< R_SYS_SystemClockMOCOSet() section */
...
#define SYSTEM_CFG_SECTION_R_SYS_MAINOSCSPEEDCLOCKSTART     (SYSTEM_SECTION_CODE)   /*!< R_SYS_MainOscSpeedClockStart() section */
#define SYSTEM_CFG_SECTION_R_SYS_MAINOSCSPEEDCLOCKSTOP      (SYSTEM_SECTION_CODE)   /*!< R_SYS_MainOscSpeedClockStop() section */
#define SYSTEM_CFG_SECTION_R_SYS_HIGHSPEEDCLOCKSTART        (SYSTEM_SECTION_CODE)   /*!< R_SYS_HighSpeedClockStart() section */
#define SYSTEM_CFG_SECTION_R_SYS_HIGHSPEEDCLOCKSTOP         (SYSTEM_SECTION_CODE)   /*!< R_SYS_HighSpeedClockStop() section */
#define SYSTEM_CFG_SECTION_R_SYS_MEDIUMSPEEDCLOCKSTART      (SYSTEM_SECTION_CODE)   /*!< R_SYS_MediumSpeedClockStart() section */
#define SYSTEM_CFG_SECTION_R_SYS_MEDIUMSPEEDCLOCKSTOP       (SYSTEM_SECTION_CODE)   /*!< R_SYS_MediumSpeedClockStop() section */
#define SYSTEM_CFG_SECTION_R_SYS_LOWSPEEDCLOCKSTART         (SYSTEM_SECTION_CODE)   /*!< R_SYS_LowSpeedClockStart() section */
