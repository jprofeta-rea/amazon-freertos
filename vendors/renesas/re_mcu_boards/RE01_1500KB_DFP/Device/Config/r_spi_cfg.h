...
#define SPI_CFG_R_SPRI_HANDLER           (SYSTEM_SECTION_CODE) //< r_spri_handler() section
#define SPI_CFG_R_SPTI_HANDLER           (SYSTEM_SECTION_CODE) //< r_spti_handler() section
#define SPI_CFG_R_SPII_HANDLER           (SYSTEM_SECTION_CODE) //< r_spii_handler() section
#define SPI_CFG_R_SPEI_HANDLER           (SYSTEM_SECTION_CODE) //< r_spei_handler() section
#define SPI_CFG_R_SPTEND_HANDLER         (SYSTEM_SECTION_CODE) //< r_sptend_handler() section
/* @} */
