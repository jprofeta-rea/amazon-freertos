...
*/
#define SCI0_TXI_PRIORITY       (2)                 ///< TXI0 priority value(set to 0 to 3, 0 is highest priority.)
#define SCI0_RXI_PRIORITY       (2)                 ///< RXI0 priority value(set to 0 to 3, 0 is highest priority.)
#define SCI0_ERI_PRIORITY       (2)                 ///< ERI0 priority value(set to 0 to 3, 0 is highest priority.)
// changed 2020/10 end
...
*/
#define SCI9_TXI_PRIORITY       (1)                 ///< TXI9 priority value(set to 0 to 3, 0 is highest priority.)
#define SCI9_RXI_PRIORITY       (1)                 ///< RXI9 priority value(set to 0 to 3, 0 is highest priority.)
#define SCI9_ERI_PRIORITY       (1)                 ///< ERI9 priority value(set to 0 to 3, 0 is highest priority.)
// changed 2020/10 end
