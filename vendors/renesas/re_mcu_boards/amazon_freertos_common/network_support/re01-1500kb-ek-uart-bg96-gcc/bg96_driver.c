...
/////    timeout_init(1, 15000);         // timeout 15s
    timeout_init(1, 8000);         // timeout 10ms
// changed 2020/10 end
    while (1)
    {
// changed 2020/10 start
...
//    if (ARM_DRIVER_OK != gsp_sci5_dev->Initialize(usart_callback))
...
//	sci_err = gsp_sci5_dev->PowerControl(ARM_POWER_OFF);
...
/////        timeout_init(1, 10000);         // timeout 10s
        timeout_init(1, 5000);         // timeout 10ms
// changed 2020/10 end
        while (1)
        {
// changed 2020/10 start
