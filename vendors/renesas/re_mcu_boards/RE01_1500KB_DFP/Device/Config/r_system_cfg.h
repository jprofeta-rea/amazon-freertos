...
#define SYSTEM_CFG_EVENT_NUMBER_SCI5_RXI            (SYSTEM_IRQ_EVENT_NUMBER0)  /*!< Numbers 0/8/16/24 only */
...
#define SYSTEM_CFG_EVENT_NUMBER_SCI4_RXI            (SYSTEM_IRQ_EVENT_NUMBER4)  /*!< Numbers 4/12/20/28 only */
...
#define SYSTEM_CFG_EVENT_NUMBER_SCI5_TXI            (SYSTEM_IRQ_EVENT_NUMBER1)  /*!< Numbers 1/9/17/25 only */
...
#define SYSTEM_CFG_EVENT_NUMBER_SCI4_TXI            (SYSTEM_IRQ_EVENT_NUMBER5)  /*!< Numbers 5/13/21/29 only */
...
#define SYSTEM_CFG_EVENT_NUMBER_SCI5_ERI            (SYSTEM_IRQ_EVENT_NUMBER3)  /*!< Numbers 3/11/19/27 only */
...
#define SYSTEM_CFG_EVENT_NUMBER_SCI4_ERI            (SYSTEM_IRQ_EVENT_NUMBER7)  /*!< Numbers 7/15/23/31 only */
